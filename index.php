...
<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
    ...
    <div class="social">
    	...
    	<div class="twitter"> <a href="https://twitter.com/share" data-url="<?php the_permalink() ?>" class="twitter-share-button" data-text="<?php the_title(); ?>" data-lang="en" data-via="svballangrud">Tweet</a></div>
    </div>
